...
<html>
    <head>
        ...
        <script src="${pageContext.request.contextPath}/static/js/controller/order_details_controller.js"></script>
...
<!--                                        <div class="col-sm-4">
        ...
        <div class="content">
            <div class="container">
                ...
                .
                <div ng-controller="OdetailController as objCtrl">
                    <h1> OrderDetails Info </h1>
                    <form name="objForm" method="POST">
                        <table>
                            <tr><td colspan="2">
                                    <div ng-if="objCtrl.flag != 'edit'">
                                        <h3> Add OrderDetails </h3> 
                                    </div>
                                    <div ng-if="objCtrl.flag == 'edit'">
                            ...
                            <tr>
                                ...
                                <td>Quantity</td>
                                <td>
                                    <select ng-model="objCtrl.obj.order" ng-options="y.orderQty for y in nams">
                                    </select>
                                </td>
                            </tr>
                            ...
                            <!--                    <tr>
                                                    <td>Tprice: </td> <td><input type="text" name="bookTotalPrice" ng-model="objCtrl.obj.bookTotalPrice" required/> 
                                                        <span ng-show="objForm.bookTotalPrice.$error.required" class="msg-val">Tprice is required.</span> </td>
                                                </tr>-->
                            <tr>
                    ...
                    <table class="table table-condensed">
                        ...
                        <tr ng-repeat="row in objCtrl.objArray">
                            ...
                            <td><span ng-bind="row.order.orderQty"></span></td>

                            <td><span ng-bind="row.bookPrice"></span></td>
                            <td><span ng-bind="row.bookTotalPrice"></span></td>
                            <td><span ng-bind="row.bookDiscount"></span></td>
                            <td><span ng-bind="row.bookNetPrice"></span></td>
