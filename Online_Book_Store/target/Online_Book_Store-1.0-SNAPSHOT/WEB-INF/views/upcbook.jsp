...
<!--                                        <div class="col-sm-4">
        ...
        <div class="content">
            <div class="container">
                ...
                .
                <div ng-controller="UpBookController as objCtrl">
                    <h1> UpcomingBook Info </h1>
                    <form name="objForm" method="POST">
                        <table class="table-bordered">
                            <tr><td colspan="2">
                                    <div ng-if="objCtrl.flag != 'edit'">
                                        <h3> Add New UpcomingBook </h3> 
                                    </div>
                                    <div ng-if="objCtrl.flag == 'edit'">
                                        <h3> Update UpcomingBook for ID: {{ objCtrl.obj.bookId}} </h3> 
                                    </div> </td>
                            </tr>
                            <tr>
                                <td>Author Name: </td> <td><input type="text" name="authName" ng-model="objCtrl.obj.authName" required/> 
                                    <span ng-show="objForm.authName.$error.required" class="msg-val">Name is required.</span> </td>
                            </tr>
                            <tr>
                                <td>Publish Date: </td> <td> <input type="date" name="pdate" ng-model="objCtrl.obj.pdate" required/> 
                                    <span ng-show="objForm.pdate.$error.required" class="msg-val">PDate is required.</span> </td>
                            </tr>

                            <tr>
                                <td colspan="2"> <span ng-if="objCtrl.flag == 'created'" class="msg-success">UpcomingBook successfully added.</span>
                                    <span ng-if="objCtrl.flag == 'failed'" class="msg-val">UpcomingBook already exists.</span> </td>
                            </tr>
                            <tr><td colspan="2">
                                    <div ng-if="objCtrl.flag != 'edit'">
                                        <input  type="submit" ng-click="objCtrl.addObject()" value="Add UpcomingBook"/> 
                                        <input type="button" ng-click="objCtrl.reset()" value="Reset"/>
                                    </div>
                                    <div ng-if="objCtrl.flag == 'edit'">
                                        <input  type="submit" ng-click="objCtrl.updateObjectDetail()" value="Update UpcomingBook"/> 	
                                        <input type="button" ng-click="objCtrl.cancelUpdate()" value="Cancel"/>				   
                                    </div> </td>
                            </tr>
                            <tr>
                                <td colspan="2"> <span ng-if="objCtrl.flag == 'deleted'" class="msg-success">UpcomingBook successfully deleted.</span>
                            </tr>
                        </table>     
                    </form>
                    <table class="table table-condense">
                        <tr class="active"><th>ID </th> <th>Author Name</th> <th>pDate</th></tr>
                        <tr ng-repeat="row in objCtrl.objArray">
                            <td><span ng-bind="row.bookId"></span></td>
                            <td><span ng-bind="row.authName"></span></td>
                            <td><span ng-bind="row.pdate"></span></td>
                            ...
                            <td>
                                ...
                                <span ng-if="objCtrl.flag == 'updated' && row.bookId == objCtrl.updatedId" class="msg-success">UpcomingBook successfully updated.</span> </td> 
                        </tr>	
                    </table>
                </div>
