<%-- 
    Document   : single
    Created on : Jul 30, 2018, 10:50:12 AM
    Author     : B2
--%>
			...
			<div class="new-product">
				<div class="col-md-5 zoom-grid">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="${pageContext.request.contextPath}/static/images/si.jpg">
								<div class="thumb-image"> <img src="${pageContext.request.contextPath}/static/images/si.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="${pageContext.request.contextPath}/static/images/si1.jpg">
								<div class="thumb-image"> <img src="${pageContext.request.contextPath}/static/images/si1.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li>
							<li data-thumb="${pageContext.request.contextPath}/static/images/si2.jpg">
							<div class="thumb-image"> <img src="${pageContext.request.contextPath}/static/images/si2.jpg" data-imagezoom="true" class="img-responsive" alt="" /> </div>
							</li> 
						</ul>
					</div>
				</div>
		  ...
		  <div class="response">
						<div class="media response-info">
							<div class="media-left response-text-left">
								<a href="#">
									<img class="media-object" src="${pageContext.request.contextPath}/static/images/icon1.png" alt="" />
								</a>
