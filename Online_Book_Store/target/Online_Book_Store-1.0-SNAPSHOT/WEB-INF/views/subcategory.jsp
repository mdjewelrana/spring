...
<!--                                        <div class="col-sm-4">
        ...
        <div class="content">
            <div class="container">
                ...
                .
                 <div ng-controller="SubCatController as objCtrl">
            ...
            <form name="objForm" method="POST">
                <table>
                    ...
                    <tr>
                        <td>SubCategory Name: </td> <td><input type="text" name="subCatName" ng-model="objCtrl.obj.subCatName" required/> 
                            <span ng-show="objForm.subCatName.$error.required" class="msg-val">SubCategory Name is required.</span> </td>
                    </tr>
                    <tr>
                        <td>Description: </td> <td><input type="text" name="subCatDesc" ng-model="objCtrl.obj.subCatDesc" required/> 
                            <span ng-show="objForm.subCatDesc.$error.required" class="msg-val">Description is required.</span> </td>
                    </tr>
