<%-- 
    Document   : product
    Created on : Jul 30, 2018, 10:35:59 AM
    Author     : B2
--%>
	   ...
	   <div class="products-page">
			<div class="products">
				...
				<div class="latest-bis">
					<img src="${pageContext.request.contextPath}/static/images/l4.jpg" class="img-responsive" alt="" />
					<div class="offer">
						<p>40%</p>
				...
				<div class="mens-toolbar">
                 <div class="sort">
               	   <div class="sort-by">
			            ...
			            <a href=""><img src="${pageContext.request.contextPath}/static/images/arrow2.gif" alt="" class="v-middle"></a>
	                   </div>
	    		     </div>
							...
							<a class="cbp-vm-image" href="single.html">
							 ...
							 <div class="view view-first">
								...
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p1.jpg" class="img-responsive" alt=""/>
									<div class="mask">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
							  ...
							  <div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p2.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p3.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p4.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p5.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p6.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p7.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p8.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
						...
						<li>
							<a class="cbp-vm-image" href="single.html">
								...
								<div class="view view-first">
					   		  <div class="inner_content clearfix">
								<div class="product_image">
									<img src="${pageContext.request.contextPath}/static/images/p9.jpg" class="img-responsive" alt=""/>
									<div class="mask">
			                       		<div class="info">Quick View</div>
					                  </div>
									<div class="product_container">
   ...
   <!-- content-section-ends -->
		...
		<div class="container">
			<h3 class="like text-center">Featured Collection</h3>        			
				     <ul id="flexiselDemo3">
						<li><a href="single.html"><img src="${pageContext.request.contextPath}/static/images/l1.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Perfectly simple</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$759</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="${pageContext.request.contextPath}/static/images/l2.jpg" class="img-responsive"/></a>						
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Praising pain</a>
							<p><a class="item_add" href="#"><i></i> <span class=" item_price">$699</span></a></p>
							</div>
						</li>
						<li><a href="single.html"><img src="${pageContext.request.contextPath}/static/images/l3.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
						...
						<li><a href="single.html"><img src="${pageContext.request.contextPath}/static/images/l5.jpg" class="img-responsive"/></a>
							<div class="product liked-product simpleCart_shelfItem">
							<a class="like_name" href="single.html">Perfectly simple</a>
