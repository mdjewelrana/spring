            ...
            <div class="container">
                ...
                <div ng-controller="UserController as objCtrl">
                    ...
                    <form name="userForm" method="POST">
                        <table>
                            <tr><td colspan="2">
                                    ...
                                    <div ng-if="objCtrl.flag == 'edit'">
                                        <h3> Update User for ID: {{ objCtrl.user.userId}} </h3> 
                                    </div> </td>
                            </tr>
                            <td>Role Name</td>
                        <td>
                            <select ng-model="objCtrl.user.userRole" ng-options="x.roleName for x in names">
</select>
                        </td>
                            <tr>
                                <td>User Name: </td> <td><input type="text" name="userName" ng-model="objCtrl.user.userName" required/> 
                                    <span ng-show="userForm.userName.$error.required" class="msg-val">Name is required.</span> </td>
                            </tr>
                            <tr>
                                <td>Address: </td> <td> <input type="text" name="userAddress" ng-model="objCtrl.user.userAddress" required/> 
                                    <span ng-show="userForm.userAddress.$error.required" class="msg-val">Address is required.</span> </td>
                            </tr>
                            <tr>
                                <td>Phone: </td> <td> <input type="text" name="phone" ng-model="objCtrl.user.phone" required/> 
                                    <span ng-show="userForm.phone.$error.required" class="msg-val">Phone is required.</span> </td>
                            </tr>
                            <tr>
                                <td>Email: </td> <td> <input type="email" name="email" ng-model="objCtrl.user.email" required/> 
                                    <span ng-show="userForm.email.$error.required" class="msg-val">Email is required.</span> </td>
                            </tr>
                            <tr>
                                <td>Password: </td> <td> <input type="text" name="password" ng-model="objCtrl.user.password" required/> 
                                    <span ng-show="userForm.password.$error.required" class="msg-val">Password is required.</span> </td>
                            </tr>
                            <tr>
                                <td>Registration Date: </td> <td> <input type="date" name="regDate" ng-model="objCtrl.user.regDate" required/> 
                                    <span ng-show="userForm.regDate.$error.required" class="msg-val">Registration Date is required.</span> </td>
                            </tr>
                            <tr>
                                <td>Gender </td> <td> <input type="radio" value="male" name="gender" ng-model="objCtrl.user.gender" required/> Male
                                    <input type="radio" value="female" name="gender" ng-model="objCtrl.user.gender" required/> Female
                                    <span ng-show="userForm.gender.$error.required" class="msg-val">*</span> </td>
                            </tr>
                            <tr>
                            ...
                            <tr><td colspan="2">
                                    <div ng-if="objCtrl.flag != 'edit'">
                                        <input  type="submit" class="btn-primary" ng-click="objCtrl.addUser()" value="Add User"/> 
                                        <input type="button" class="btn-default" ng-click="objCtrl.reset()" value="Reset"/>
                                    </div>
                                    <div ng-if="objCtrl.flag == 'edit'">
                                        <input  type="submit" ng-click="objCtrl.updateUserDetail()" value="Update User"/> 	
                    ...
                    <table class="table table-hover">
                        <tr class="btn-info"><th>ID </th> <th>Name </th> <th>Address </th> <th>Phone </th> <th>Email </th> <th>Password</th> <th>Reg Date</th> <th>Gender</th> <th>Role Name</th>  <th>Action</th> </tr>
                        <tr ng-repeat="row in objCtrl.objArray">
                            ...
                            <td>
                                <input type="button" class="btn-danger" ng-click="objCtrl.deleteUser(row.userId)" value="Delete"/>
                                <input type="button" class="btn-success" ng-click="objCtrl.editUser(row.userId)" value="Edit"/>
