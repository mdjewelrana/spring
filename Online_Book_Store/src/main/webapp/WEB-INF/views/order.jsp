...
<!--                                        <div class="col-sm-4">
        ...
        <div class="content">
            <div class="container">
                ...
                .
               <div ng-controller="OderController as objCtrl">
            <h1> Order Info </h1>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <td>Book Url: </td>
                        <td>
                            <select ng-model="objCtrl.obj.bookList" ng-options="x.bookUrl for x in nam">
</select>
                        </td>
                    </tr>
                    <tr>
                        <td>Order Qty: </td> <td><input type="text" name="orderQty" ng-model="objCtrl.obj.orderQty" required/> 
                            <span ng-show="objForm.orderQty.$error.required" class="msg-val">Order Qty is required.</span> </td>
                    </tr>
                    <tr>
                        <td>Order Date: </td> <td><input type="date" name="orderDate" ng-model="objCtrl.obj.orderDate" required/> 
                            <span ng-show="objForm.orderDate.$error.required" class="msg-val">Order Date is required.</span> </td>
                    </tr>
                    <tr>
            ...
            <table class="table table-condensed">
                ...
                <tr ng-repeat="row in objCtrl.objArray">
                    ...
                    <td><span ng-bind="row.bookList.bookUrl"></span></td>
