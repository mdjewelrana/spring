			...
			<div class="reg-form">
				<div class="reg">
					 ...
					 <p>If you have previously registered with us, <a href="#">click here</a></p>
					   <div ng-controller="PublisherController as objCtrl">
            <h1> Category Info </h1>
            <form name="objForm" method="POST">
                <table>
                    <tr><td colspan="2">
                            ...
                            <div ng-if="objCtrl.flag == 'edit'">
                                <h3> Update Category for ID: {{ objCtrl.obj.pubId}} </h3> 
                            </div> </td>
                    </tr>
                    <tr>
                        <td>Publisher Name: </td> <td><input type="text" name="pubName" ng-model="objCtrl.obj.pubName" required/> 
                            <span ng-show="objForm.pubName.$error.required" class="msg-val">*</span> </td>
                    </tr>
                    <tr>
                        <td>Publisher Address: </td> <td> <input type="text" name="pubAddress" ng-model="objCtrl.obj.pubAddress" required/> 
                            <span ng-show="objForm.pubAddress.$error.required" class="msg-val">*</span> </td>
                    </tr>
                    <tr>
                        <td>Publisher Contact </td> <td><input type="text" name="pubContact" ng-model="objCtrl.obj.pubContact" required/> 
                            <span ng-show="objForm.pubContact.$error.required" class="msg-val">*</span> </td>
                    </tr>
                    <tr>
                        <td>Publisher Country: </td> <td> <input type="text" name="pubCountry" ng-model="objCtrl.obj.pubCountry" required/> 
                            <span ng-show="objForm.pubCountry.$error.required" class="msg-val">*</span> </td>
                    </tr>
                    
                    <tr>
                        <td colspan="2"> <span ng-if="objCtrl.flag == 'created'" class="msg-success">Publisher successfully added.</span>
                            <span ng-if="objCtrl.flag == 'failed'" class="msg-val">Publisher already exists.</span> </td>
                    </tr>
                    <tr><td colspan="2">
                            <div ng-if="objCtrl.flag != 'edit'">
                                <input  type="submit" ng-click="objCtrl.addObject()" value="Add Publisher"/> 
                                <input type="button" ng-click="objCtrl.reset()" value="Reset"/>
                            </div>
                            <div ng-if="objCtrl.flag == 'edit'">
                                <input  type="submit" class="btn-success" ng-click="objCtrl.updateObjectDetail()" value="Update Publisher"/> 	
                                <input type="button" class="btn-info" ng-click="objCtrl.cancelUpdate()" value="Cancel"/>				   
                            </div> </td>
                    </tr>
                    <tr>
                        <td colspan="2"> <span ng-if="objCtrl.flag == 'deleted'" class="msg-success">Publisher successfully deleted.</span>
                    </tr>
                </table>     
            </form>
            <table class="table table-condensed">
                <tr><th>ID </th> <th>Name</th> <th>Address</th> <th>Contact</th> <th>Country</th> </tr>
                <tr ng-repeat="row in objCtrl.objArray">
                    <td><span ng-bind="row.pubId"></span></td>
                    <td><span ng-bind="row.pubName"></span></td>
                    <td><span ng-bind="row.pubAddress"></span></td>
                    <td><span ng-bind="row.pubContact"></span></td>
                    <td><span ng-bind="row.pubCountry"></span></td>
                    <td>
                        <input type="button" class="btn-danger" ng-click="objCtrl.deleteObject(row.pubId)" value="Delete"/>
                        <input type="button" class="btn-primary" ng-click="objCtrl.editObject(row.pubId)" value="Edit"/>
                        <span ng-if="objCtrl.flag == 'updated' && row.pubId == objCtrl.updatedId" class="msg-success">Publisher successfully updated.</span> </td> 
                </tr>	
            </table>
              <script src="${pageContext.request.contextPath}/static/js/controller/publisher_controller.js"></script>
        </div>
				 </div>
			</div>
			<div class="reg-right">
