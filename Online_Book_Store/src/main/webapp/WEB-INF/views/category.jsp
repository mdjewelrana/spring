...
<!--                <div class="col-md-3">
					<h2>our Products</h2>
					<ul class="active" class="product-list">
            ...
            <form name="objForm" method="POST">
                <table>
                    <tr><td colspan="2">
                            ...
                            <div ng-if="objCtrl.flag == 'edit'">
                                <h3> Update Category for ID: {{ objCtrl.obj.catId}} </h3> 
                            </div> </td>
                    </tr>
                    <tr>
                        <td>Category Name: </td> <td><input type="text" name="catName" ng-model="objCtrl.obj.catName" required/> 
                            <span ng-show="objForm.catName.$error.required" class="msg-val">Name is required.</span> </td>
                    </tr>
                    <tr>
                        <td>Category Description: </td> <td> <input type="text" name="catDesc" ng-model="objCtrl.obj.catDesc" required/> 
                            <span ng-show="objForm.catDesc.$error.required" class="msg-val">catDesc is required.</span> </td>
                    </tr>
                    ...
                    <tr><td colspan="2">
                            <div ng-if="objCtrl.flag != 'edit'">
                                <input  type="submit" class="btn-success" ng-click="objCtrl.addObject()" value="Add Book"/> 
                                <input type="button" class="btn-danger" ng-click="objCtrl.reset()" value="Reset"/>
                            </div>
                            <div ng-if="objCtrl.flag == 'edit'">
                                <input  type="submit" class="btn-success" ng-click="objCtrl.updateObjectDetail()" value="Update Book"/> 	
                                <input type="button" class="btn-default" ng-click="objCtrl.cancelUpdate()" value="Cancel"/>				   
                            </div> </td>
                    </tr>
                    <tr>
            ...
            <table class="table table-responsive">
                <tr class="table btn-default" ><th>ID </th> <th>Name</th> <th>Description</th></tr>
                <tr ng-repeat="row in objCtrl.objArray">
                    ...
                    <td>
                        <input type="button" class="btn-danger" ng-click="objCtrl.deleteObject(row.catId)" value="Delete"/>
                        <input type="button" class="btn-success" ng-click="objCtrl.editObject(row.catId)" value="Edit"/>
